document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('input', function(e) {
            ...
            if (input && input.parentElement.querySelector('.form-error')) {
                validateField(input);
            }
        });
...
(function(){
  ...
  function revealAllStatically(){
    ...
    var hidden = document.querySelectorAll('[data-reveal],[data-reveal-stagger] > *,[data-clip-reveal],[data-split-text]');
...
/* SIGNATURE MOMENT: scroll-progress-bar */
(function(){

      (function(){
        var bar = document.createElement('div'); bar.className = 'zsm-progress'; var fill = document.createElement('span'); bar.appendChild(fill); document.body.appendChild(bar);
        function update(){ var h = document.documentElement.scrollHeight - window.innerHeight; var p = h > 0 ? (window.scrollY / h) * 100 : 0; fill.style.width = p.toFixed(2) + '%'; }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '06563b8d-215b-47f3-a5c0-c497921f1e57',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '06563b8d-215b-47f3-a5c0-c497921f1e57';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '06563b8d-215b-47f3-a5c0-c497921f1e57';
